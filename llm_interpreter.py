...
def interpretar_resultado(
    dados_paciente: dict, predicao: int, probabilidade: float
    ...
    """
    resultado_texto = (
        "POSITIVO para diabetes" if predicao == 1 else "NEGATIVO (saudável)"
    )
...
"""
    ...
    try:
        ...
        return {"prompt": prompt, "response": response.message.content}
